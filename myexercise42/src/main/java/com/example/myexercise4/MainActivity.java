...
import com.example.myexercise4.data.OnDataLoadCallback;
import com.example.myexercise4.model.Contact;
import com.example.myexercise4.recyclerview.ContactAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private SwipeRefreshLayout swReLa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swReLa = (SwipeRefreshLayout) findViewById(R.id.swipeRefreshLayout);
    ...
    private void loadContacts() {
        ...
        MyApplication.getContactRepo().findAllWithBirthday(new OnDataLoadCallback<List<Contact>>() {
            ...
            public void onDataLoaded(List<Contact> data) {
                Log.i(MainActivity.class.getSimpleName(), data.size() + "contact Loaded");
                swReLa.setRefreshing(false);
                onDataLoaded(data);
            }
            ...
            public void onDataLoadError(Exception exception) {
                ...
                swReLa.setRefreshing(true);
                Snackbar.make(recyclerView, "Konnte keine Kontakte ladeb", Snackbar.LENGTH_INDEFINITE)
                        .setAction("Erneuert versuchen", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                loadContacts();
                            }
