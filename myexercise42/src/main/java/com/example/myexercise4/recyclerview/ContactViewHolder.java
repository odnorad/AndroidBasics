package com.example.myexercise4.recyclerview;
...
import com.example.myexercise4.R;
...
class ContactViewHolder extends RecyclerView.ViewHolder {
    ...
    void update(Contact contact) {
        image.setImageResource(contact.hasBirthday() ? R.drawable.ic_cake_black_24dp : R.drawable.ic_person_black_24dp);
